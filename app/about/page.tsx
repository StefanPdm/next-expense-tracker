      ...
      <section className='py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm relative overflow-hidden'>
        ...
        <div className='max-w-4xl mx-auto text-center'>
          ...
          <p className='text-lg md:text-xl text-gray-600 dark:text-gray-400 leading-relaxed max-w-3xl mx-auto'>
            At ExpenseTracker AI, we leverage cutting-edge artificial intelligence to revolutionize
            how individuals achieve financial wellness. Our AI analyzes your spending patterns to
            deliver personalized recommendations and actionable insights that lead to better
        ...
        <div className='max-w-6xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <h2 className='text-4xl md:text-5xl font-bold mb-6 text-gray-900 dark:text-gray-100'>
              Why Choose{' '}
              <span className='text-emerald-600 dark:text-emerald-400'>ExpenseTracker AI?</span>
            </h2>
            <p className='text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto'>
              Discover the powerful features that make our AI-driven platform the smart choice for
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1'>
              ...
              <div className='relative z-10'>
                ...
                <p className='text-gray-600 dark:text-gray-400 leading-relaxed'>
                  ...
                  recommendations and automated category suggestions that learn from your behavior.
                </p>
              </div>
            </div>
            ...
            <div className='group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1'>
              ...
              <div className='relative z-10'>
                ...
                <p className='text-gray-600 dark:text-gray-400 leading-relaxed'>
                  Let our AI automatically categorize your expenses with 99% accuracy and provide
                  tailored recommendations to enhance your budget management effortlessly.
                </p>
              </div>
            </div>
            ...
            <div className='group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1'>
              ...
              <div className='relative z-10'>
                ...
                <p className='text-gray-600 dark:text-gray-400 leading-relaxed'>
                  Experience a modern, AI-enhanced interface with real-time insights, interactive
                  financial analytics, and beautiful visualizations that make sense of your data.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
            <div className='space-y-6'>
              <p className='text-lg text-gray-600 dark:text-gray-400 leading-relaxed'>
                ExpenseTracker AI was born from the vision of creating truly intelligent financial
                management tools. Our team of financial experts, data scientists, and technologists
                came together to solve a critical problem: making personal finance management
                smarter, more intuitive, and more effective.
              </p>
              <p className='text-lg text-gray-600 dark:text-gray-400 leading-relaxed'>
                Since our launch, we&#39;ve helped thousands of users achieve better budgeting and
                improve their overall financial health through the power of artificial intelligence.
      ...
      <section className='py-20 px-8 bg-gradient-to-br from-gray-50 via-white to-emerald-50 dark:from-gray-900 dark:via-gray-800 dark:to-emerald-900/20 relative overflow-hidden'>
        ...
        <div className='max-w-4xl mx-auto text-center relative z-10'>
          ...
          <p className='text-xl md:text-2xl mb-10 text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed'>
            Join thousands of users who have already transformed their financial habits with
            ExpenseTracker AI. Start your journey towards smarter budgeting today.
          </p>
